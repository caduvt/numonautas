      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 relative z-10 items-center px-4">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4 mb-2 lg:mb-4">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-indigo-100 astro-title drop-shadow-md">
              Parâmetros da Missão
            </h2>
          </div>

          <div className="bg-slate-800/40 backdrop-blur-lg rounded-4xl p-6 lg:p-8 border-2 border-slate-600/30 shadow-[0_0_30px_rgba(30,27,75,0.6)] flex flex-col gap-6 w-full">
            {/* Box 1: Dificuldade */}
            <div className="bg-slate-800/60 rounded-2xl p-6 flex items-center justify-between border border-slate-700/50 hover:bg-slate-700/40 transition-colors">
              <span className="text-slate-300 font-semibold font-nunito text-xl lg:text-2xl">
                Dificuldade
              </span>
            ...
            <div className="bg-slate-800/60 rounded-2xl p-6 flex items-center justify-between border border-slate-700/50 hover:bg-slate-700/40 transition-colors">
              ...
              <div
                className={`p-4 rounded-xl transition-all duration-500 transform scale-125 ${
                  config.audio_enabled
                    ? "bg-emerald-500/20 text-emerald-400 border-2 border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.3)]"
                    : "bg-rose-500/20 text-rose-500 border-2 border-rose-500/30"
                }`}
              >
                {config.audio_enabled ? (
                  <Volume2 size={28} />
              ...
              <div
                className={`p-4 rounded-xl transition-all duration-500 transform scale-125 ${
                  config.animacoes_enabled
                    ? "bg-purple-500/20 text-purple-400 border-2 border-purple-500/40 shadow-[0_0_15px_rgba(168,85,247,0.3)]"
                    : "bg-slate-700/40 text-slate-500 border-2 border-slate-600/30"
                }`}
              >
                <Sparkles size={28} />
              </div>
